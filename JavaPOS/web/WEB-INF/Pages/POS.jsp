    ...
    <body>
        ...
        <div id="content">
            ...
            { %> 
             <div id="adminPage"> 
                 <div class="w-25 p-3 mx-auto">
                    ...
                    <input class="btn btn-primary btn-lg btn-block" type="button" onclick="location.href='${pageContext.request.contextPath}/Sales'" value="Sales" />
                </div>     
            </div>        
             <% } 
                else { 
            ...
            <div id="cashierPage" class="d-flex justify-content-center"> 
                ...
                <input class="btn btn-warning w-25" type="button" onclick="location.href='${pageContext.request.contextPath}/AddReturn';" value="Retur Nou" />
            </div>
          <% } %>
        </div>
